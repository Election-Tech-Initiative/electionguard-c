...
void Serialize_read_uint64_ts(struct serialize_state *state, mpz_t data,
                              int ct);
...
void Serialize_reserve_encrypted_ballot(
    struct serialize_state *state, struct encrypted_ballot_rep const *data);
