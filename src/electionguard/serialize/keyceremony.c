                                     ...
                                     struct key_generated_rep const *data)
{
    ...
    Serialize_reserve_rsa_public_key(state, &data->rsa_public_key);
}
                                   ...
                                   struct key_generated_rep const *data)
{
    ...
    Serialize_write_rsa_public_key(state, &data->rsa_public_key);
}
                                  ...
                                  struct key_generated_rep *data)
{
    ...
    Serialize_read_rsa_public_key(state, &data->rsa_public_key);
}
    ...
    struct serialize_state *state, struct all_keys_received_rep const *data)
{
    ...
    for (uint32_t i = 0; i < data->num_trustees; i++)
    {
        ...
        Serialize_reserve_rsa_public_key(state, &data->rsa_public_keys[i]);
    }
}
                                       ...
                                       struct all_keys_received_rep const *data)
{
    ...
    for (uint32_t i = 0; i < data->num_trustees; i++)
    {
        ...
        Serialize_write_rsa_public_key(state, &data->rsa_public_keys[i]);
    }
}
                                      ...
                                      struct all_keys_received_rep *data)
{
    ...
    for (uint32_t i = 0; i < data->num_trustees; i++)
    {
        ...
        Serialize_read_rsa_public_key(state, &data->rsa_public_keys[i]);
    }
}
